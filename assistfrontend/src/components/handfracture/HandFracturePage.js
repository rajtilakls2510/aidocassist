...
const HandFracturePage = () => {
  ...
  const [predictions, setPredictions] = useState({ detected: null });
  ...
  return (
    <main className="page pred-page">
      <section className="header-section">
        <h3 className="title">Hand Fracture Detector</h3>
        <div className="title-underline"></div>
      </section>

      <section className="covid-description-section">
        <p>
          Upload your Hand X-Ray image and we will detect where your fracture
          is.
        </p>
      </section>
      <section className="covid-upload-section">
        <div className="covid-file-selection-container">
          <h5 className="disease-pred-title">
            Please select your Hand X-Ray file:
          </h5>
      ...
      <section className="covid-preview-prediction-section">
        ...
        >
          {notification.there ? (
            ...
            <>
              <h5 className="symptom-container-title">Detected Fracture</h5>
              <img
                src={`data:image/png;base64,${predictions.detected}`}
                alt=""
...
export default HandFracturePage;
